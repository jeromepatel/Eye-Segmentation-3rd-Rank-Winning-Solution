...
@author: jyotm
usage, eg: python test_eyesemseg.py --log_dir pre_trained_model --test_dir test --save_labels True
"""
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, default='1', help='specify gpu/cpu device')
    parser.add_argument('--num_point', type=int, default=10096, help='point number [default: 10096]')
    parser.add_argument('--log_dir', type=str, required=True, help='experiment root')
    parser.add_argument('--save_labels',type= bool, default = False, help='save prediction labels into folders [default: False]')
    parser.add_argument('--valid',type=bool, default = False, help='validate result on valid dataset [default: False]')
    parser.add_argument('--test_dir', type=str,default='val', help='test dir [default: val]')
